...
public class UserController {
    ...
    public Map<String,Object> getAllVehicules(@PathVariable Long userId){

        return service.getUserAndVehicules(userId);
    }
}
